...
FREE_MODE_ASSISTANT_GLOSSARY: dict[str, str] = {
    ...
    "eksport": "zapisanie gotowych danych do formatu używanego dalej, np. XML, YOLO albo paczki CVAT.",
    "fit": "dopasowanie ramek do obrazu lub obszaru pracy, aby wynik był spójny z podglądem.",
    "gold pack": "wybrana, zaufana paczka przykładów, z której buduje się lepszy dataset znaków.",
    ...
    "preview run": "robocza paczka podglądowa, zwykle używana do sprawdzenia cropów przed dalszym etapem.",
    ...
    "review pack": "paczka przykładów przygotowana do ręcznego sprawdzenia, często poza aplikacją.",
...
class FreeModeAssistantOverlay:
    ...
    def __init__(self, root: tk.Misc):
        ...
        self.title_lbl = tk.Label(
            self.frame,
            text="Asystent trybu swobodnego  |  GRAB",
            anchor="w",
            justify=tk.LEFT,
            bd=0,
