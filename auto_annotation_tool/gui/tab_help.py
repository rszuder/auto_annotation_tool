...
class HelpTab:
    ...
    def _fill_architecture(self, t):
        ...
        t.insert(tk.END, "- Docelowo system ma wspierać master pool, generator paczek iteracyjnych, pamięć użytych zdjęć i dobór kolejnych próbek przez balans oraz active learning.\n", "LIST")
