    ...
    if free_mode_context and free_mode_route == "auto" and free_mode_screen == "auto_summary":
        return {
            ...
            "workflow": (
                ...
                "Po samej autoanotacji akcja „Przejdź do Z3” i eksport datasetu YOLO Pose pozostają zablokowane, jeśli nie ma pozycji [OK].",
                ...
                "„Przejdź do Z3” prowadzi do Z3/PZ1 i przygotowuje tablice do dalszej pracy nad znakami.",
    ...
    if free_mode_context and free_mode_route == "manual" and free_mode_screen == "manual_review":
        return {
            ...
            "workflow": (
                ...
                "„Przejdź do Z3” prowadzi do Z3/PZ1 i przygotowuje tablice do anotacji znaków.",
                "„Przejdź do eksportu” przenosi do kroku Eksport, gdzie wybierasz pakiet anotacji XML albo dataset tablic YOLO Pose do treningu w Z4.",
